# Relevant prompt for Inserting the instruction into the LLM
from typing import Dict, Any

from main import synthesize_analyses
...
class PromptTemplates:
    ...
    def reddit_url_analysis_system() -> str:
        ...
        Analyze the provide Reddit results and identify URLs of posts that contain valuable information worth investigating further. Focus on posts that:
    ...
    def bing_analysis_system() -> str:
        ...
        Provide a Concise analysis highlighting unique finding and perspectives.
        """
    ...
    def reddit_analysis_system() -> str:
        """System prompt for analyzing Reddit discussion."""
        return """
        You are an expert analyzing social media discussions. Analyze the provided Reddit content to extract community insights and user experiences.
...
# this function return the message pair for the instruction in LLM
...
# this is message pair specially for the google analysis
...
# message pair specially for the bing response
